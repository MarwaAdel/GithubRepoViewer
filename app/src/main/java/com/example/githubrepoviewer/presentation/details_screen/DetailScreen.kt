...
import com.example.githubrepoviewer.presentation.shared.ErrorUI
import com.example.githubrepoviewer.presentation.shared.IdleUI
import com.example.githubrepoviewer.presentation.shared.navigation.OuterClass
...
fun DetailScreen(name: String, owner: String, detailsViewModel: DetailsVm, navController: NavHostController) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Repository Detail Screen", style = MaterialTheme.typography.h6) },
